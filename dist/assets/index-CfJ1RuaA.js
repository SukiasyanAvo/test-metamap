...
const SplashScreen = registerPlugin("SplashScreen", {
  web: () => __vitePreload(() => import("./web-DeTDdPTZ.js"), true ? [] : void 0).then((m) => new m.SplashScreenWeb())
});
var CameraSource;
...
window.customElements.define(
  ...
  class extends HTMLElement {
    ...
    connectedCallback() {
      const self2 = this;
      const metaMapBtn = self2.shadowRoot.querySelector("#show-metamap-flow");
      if (metaMapBtn) {
        metaMapBtn.addEventListener("click", () => self2.showMetaMapFlow());
      }
